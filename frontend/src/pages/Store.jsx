    ...
    return (
        <div className='p-4'>
            ...
            <div className='flex justify-between items-center'>
                <h1 className='text-3xl my-8'>MerchItems List</h1>
                <Link to='/merchitems/create'>
                    <MdOutlineAddBox className='text-sky-800 text-4xl' />
                </Link>
            </div>
            {loading ? (<Spinner />) : showType === 'table' ? (<MerchItemsTable merchItems={merchitems} />) : (<MerchItemsCard merchItems={merchitems} />)}
        </div>
    )
}
